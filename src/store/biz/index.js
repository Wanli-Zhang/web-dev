  ...
  actions: {
    [actionTypes.FETCH_MERCHANTS]: ({commit}) => {
      return new Promise((resolve, reject) => {
        Vue.axios.get('/webapi/v1/merchants', {withCredentials: false}).then(res => {
    ...
    [actionTypes.FETCH_CUSTOMERS]: ({commit}) => {
      return new Promise((resolve, reject) => {
        Vue.axios.get('/webapi/v1/customers', {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.FETCH_CUSTOMERS_OF_MERCHANT]: ({commit}, mUsername) => {
      return new Promise((resolve, reject) => {
        Vue.axios.get(`/webapi/v1/merchant/${mUsername}/customers`, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
            commit(mutationTypes.SET_CUSTOMERS, res.data.data)
          } else {
            reject(res.data.err_msg)
    ...
    [actionTypes.ADD_MERCHANT]: ({commit}, merchant) => {
      return new Promise((resolve, reject) => {
        Vue.axios.post('/webapi/v1/merchants', merchant, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.ADD_CUSTOMER]: ({commit}, customer) => {
      return new Promise((resolve, reject) => {
        Vue.axios.post('/webapi/v1/customers', customer, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.DELETE_MERCHANT]: ({commit}, mUsername) => {
      return new Promise((resolve, reject) => {
        Vue.axios.delete(`/webapi/v1/merchant/${mUsername}`, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.DELETE_CUSTOMER]: ({commit}, mUsername) => {
      return new Promise((resolve, reject) => {
        Vue.axios.delete(`/webapi/v1/customer/${mUsername}`, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.UPDATE_MERCHANT]: ({commit}, merchant) => {
      return new Promise((resolve, reject) => {
        Vue.axios.put(`/webapi/v1/merchant/${merchant.username}`, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
    ...
    [actionTypes.UPDATE_CUSTOMER]: ({commit}, customer) => {
      return new Promise((resolve, reject) => {
        Vue.axios.put(`/webapi/v1/customer/${customer.username}`, {withCredentials: false}).then(res => {
          if (res.data.err_code === 0) {
